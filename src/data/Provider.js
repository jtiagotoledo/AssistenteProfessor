...
export default function Provider({children}) {
  ...
  const [recarregarDadosProfessor, setRecarregarDadosProfessor] =
    useState(false);
  ...
  const [recarregarDatasMarcadasFreq, setRecarregarDatasMarcadasFreq] =
    useState(false);
  const [recarregarDatasMarcadasNotas, setRecarregarDatasMarcadasNotas] =
    useState(false);
  ...
  return (
    <Context.Provider
      value={{
        ...
        setflagLoadAlunos,
        flagLoadFrequencia,
        setFlagLoadFrequencia,
        flagLoadNotas,
        setFlagLoadNotas,
        flagLoadCalendarioFreq,
        setflagLoadCalendarioFreq,
        flagLoadCalendarioNotas,
        setflagLoadCalendarioNotas,
        flagLoadAbas,
        setFlagLoadAbas,
        flagLongPressClasse,
