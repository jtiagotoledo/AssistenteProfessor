  ...
  const actions = [
    {
      ...
      icon: <FontIAwesomeIcon name={'calendar-plus-o'} size={width * 0.06} color="white" />, // Ajusta tamanho do ícone
      name: 'data',
      position: 1,
    },
  ];
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    justifyContent: 'flex-end', // Garante que o FAB fique posicionado na parte inferior
